...
<center>
<p style="color:yellow; font-size: 2vw">Add Student</p>
...
<input type="date" name="dates" placeholder="Enter Student Date of Birth" required><br/>

<label>Student Email</label><br/>
<input type="text" name="email" placeholder="Enter Student Email" required><br/>

<label>Student Phone</label><br/>
<input type="text" name="phone" placeholder="Enter Student Phone Number" required><br/>
